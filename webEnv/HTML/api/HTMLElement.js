...
setFunctionPrototype(HTMLElement, () => {
    ...
    addObjProp(HTMLElement.prototype, {
        name: 'editContex',
        get: function editContex() {
            return getPrivateProp(this, 'editContex');
        },
        set: function editContex(value) {
            return setPrivateProp(this, 'editContex', value);
        }
    });
    addObjProp(HTMLElement.prototype, {
    ...
    addObjProp(HTMLElement.prototype, {
        ...
        get: function innerText() {
            let innerText = getPrivateProp(this, 'innerText');
            const originTag = getOriginObj(this);
            if (originTag instanceof HTMLFormElement) {
                innerText = queryFormProp(this, 'innerText');
            }
            return innerText;
        },
    ...
    addObjProp(HTMLElement.prototype, {
        ...
        set: function style(value) {
            const attributeStyleMap = getPrivateProp(this, 'attributeStyleMap');
            attributeStyleMap.clear();
            const style = getPrivateProp(this, 'style');
            dealWithStyle(value, style);
            //更新attributes
            const attributes = getPrivateProp(this, 'attributes');
            attributes.setNamedItem('style', value);

            return setPrivateProp(this, 'style', style);
        }
    });
    addObjProp(HTMLElement.prototype, {
