// delete __dirname;
// delete __filename;
require(require('path').resolve(__dirname, './content'))
window = global;
...
scripts = [
        ...
        },
        {
          ...
          //去浏览器里拿
          src: "/web/home/4J1yR5VhVRtx/d7ciADUqqSZc.e8255cf.js",
        }
      ]
...
require(require('path').resolve(__dirname, './core'))
require(require('path').resolve(__dirname, './ts'))
